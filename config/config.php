<?php
//dands config ou src controllers et models seront des fichiers de classe 
/**
 ...
 */
if (!in_array( $requestedRoute ,  $paths)) {//in_array verif in_array — Indique si une valeur appartient à un tableau
